...
import 'transitions/FadeFABIcon.dart';

class SlideUpPanel extends StatefulWidget {
  final Function(double pos) notifyParent;
  const SlideUpPanel({
    Key key, @required this.notifyParent(double pos)
  }) : super(key: key);
    ...
    return SlidingUpPanel(
        ...
        panel: Padding(
          ...
          child: Column(children: <Widget>[
            ...
            formField(labelText: "Initial Amount: "),
            Row(
              children: [
                Flexible(
                  child: formField(labelText: "Interest Rate: ", hintText: ""),
                  flex: 2,
                ),
                Flexible(
...
class CalculateFAB extends StatefulWidget {
  double fabVisibility = 1.0;
  CalculateFAB({
    Key key, @required this.fabVisibility
  }) : super(key: key);
